...
\x{Key correspondence}: $B$ maps Null$(AB) \setminus$ Null$(B)$ onto Col$(B) \cap$ Null$(A) \setminus \{\mathbf{0}\}$

Therefore: Null$(AB) =$ Null$(B)$ $\Longleftrightarrow$ Col$(B) \cap$ Null$(A) = \{\mathbf{0}\}$
