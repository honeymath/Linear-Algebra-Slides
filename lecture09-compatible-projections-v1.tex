...
Cross-fill at diagonal pivot $(\rd{1},\rd{1})$:

$$P = \underbrace{\frac{1}{6}\begin{pmatrix} \bl{4} & \bl{-2} & \bl{-2} \\ \bl{-2} & \bl{1} & \bl{1} \\ \bl{-2} & \bl{1} & \bl{1} \end{pmatrix}}_{\bl{R_1},\; \operatorname{rank} = \bl{1}} + \underbrace{\frac{1}{2}\begin{pmatrix} \gn{0} & \gn{0} & \gn{0} \\ \gn{0} & \gn{1} & \gn{-1} \\ \gn{0} & \gn{-1} & \gn{1} \end{pmatrix}}_{\gn{R_2},\; \operatorname{rank} = \gn{1}}$$
