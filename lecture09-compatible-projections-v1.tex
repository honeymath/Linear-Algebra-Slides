...
\begin{frame}{Example: Diagonal Cross-Fill a Symmetric $M$}

Suppose $M = \begin{pmatrix} 1 & -1 \\ -1 & 2 \end{pmatrix}$ (symmetric, rank 2).

\vspace{0.3em}

\x{Diagonal pivot $(1,1)$}, value $= 1$:

$$Q_1 = \frac{1}{\pvt{1}}\begin{pmatrix} \pvt{1} \\ \crs{-1} \end{pmatrix}\begin{pmatrix} \pvt{1} & \crs{-1} \end{pmatrix} = \begin{pmatrix} 1 & -1 \\ -1 & 1 \end{pmatrix}$$

\vspace{0.3em}

Remainder:
$$Q_2 = M - Q_1 = \begin{pmatrix} 0 & 0 \\ 0 & 1 \end{pmatrix}$$
...
By the theorem: $R_j = UQ_jU^T$ are rank-1 \x{orthogonal} projections forming a compatible family.
