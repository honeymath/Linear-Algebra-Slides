...
Collect the existing orthonormal vectors:
...
Then the orthogonal projection onto their span is:
...
\begin{center}
\x{Cross-filling an orthogonal projection gives orthonormal vectors.}
\end{center}

\vfill

Apply that to the complement projection:
...
Cross-filling gives rank-one orthogonal projections:
...
Use these vectors as the missing output axes:
...
u_i=\frac{Av_i}{\sigma_i}.
$$
\item Complete by the previous projection method:
$$
B=(u_1\ \cdots\ u_r),\quad P=BB^T,\quad I-P.
$$
Diagonal cross-fill $I-P$.
