...
\text{Row 2}: &\quad -x_3 = 1 \quad \text{(this is \x{eq2 - 2·eq1})} \\
\text{Row 3}: &\quad -x_3 = 1 \quad \text{(this is \x{eq3 - 3·eq1})}
\end{align*}

\x{Key}: Rows 2 and 3 = same equation ($x_3 = -1$). Only \x{one independent equation}!
...
\begin{align*}
\text{Row 1}: &\quad 0 = 0 \quad \text{(trivial)} \\
\text{Row 2}: &\quad x_3 = -1 \quad \text{(\x{eq2 - 2·eq1})} \\
\text{Row 3}: &\quad x_3 = -1 \quad \text{(\x{eq3 - 3·eq1})}
\end{align*}

\x{Key}: All rows = same equation ($x_3 = -1$). Only \x{one independent equation}!
