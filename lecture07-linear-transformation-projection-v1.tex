...
\begin{frame}{Verification: Orthogonal Projection $P_1$}
...
\begin{frame}{Verification: Oblique Projection $P_2$}
...
Same floor, different sunlight $\to$ different symmetry properties.
